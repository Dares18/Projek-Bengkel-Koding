...
<div class="container text-dark" style="margin-top: 10rem;">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row d-flex justify-content-center align-items-center px-5 py-4">
                        <div class="col lg-6">
                            <img src="images/key.png" class="img-fluid" alt="login-pic">
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div class="text-center">
                                ...
                                <p class="mt-3">Login sebagai dokter? <a style="text-decoration: none;" href="index.php?page=loginDokter">Saya Dokter</a></p>
                            </div>
                        </div>
